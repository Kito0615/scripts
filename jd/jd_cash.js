/*
* ==UserScript==
* @ScriptName        领现金自动获得酬劳
* @Author            Cuttlefish
* @TgChannel         https://t.me/ddgksf2021
* @WechatID          墨鱼手记
* @UpdateTime        20210308
* @ScriptFunction    自动化完成领现金自动获得酬劳（一级0.1元；二级0.25元；三级0.55元；四级1.19元；五级1.99元；六级5元；
* @ScriptURL         https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Jd/jd_cash_reward.js
* ==/UserScript==
【QuantumultX】 :
*************************
[task_local]
15 7,15 * * * https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Jd/jd_cash_reward.js, tag=领现金自动获得酬劳
*************************
【Loon】 :
*************************
[Script]
cron "15 7,15 * * *" script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Jd/jd_cash_reward.js,tag=领现金自动获得酬劳
*************************
【Surge】 :
*************************
[Script]
...
*************************
[Script]
领现金自动获得酬劳 = type=cron,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Jd/jd_cash_reward.js, cronexpr="15 7,15 * * *", timeout=500, enable=true
*************************
[mitm]
...
const JD_API_HOST = `https://api.m.jd.com/client.action?functionId=cash_mob_reward`;
!(async () => {
  if (!cookiesArr[0]) {
...
function Withdraw_Cash(){
  return new Promise(resolve => {
    $.post(taskUrl('&body=%7B%22source%22%3A2%2C%22rewardNode%22%3A%22%22%7D&appid=CashReward&client=m&clientVersion=9.2.8'), (err, resp, data) => {
      try {
        if (err) {
      ...
      if(data.data.bizCode==0){
        ...
        $.amount  = data.data.result.shareRewardAmount;
